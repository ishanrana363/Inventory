...
import productApiStore from "../../apiRequest/productApi/productApiStore.js";
import moment from "moment/moment.js";

const ProductList = () => {
    const {productList,totalProduct,setProduct} = productApiStore();
    ...
    const handlePageChange = async (even) => {
        ...
        setLoder("");
        await setProduct(pageNo+1,perPage,0);
        setLoder("d-none");
    };
    ...
    const getPerPageData = async (even) => {
        ...
        setLoder("");
        await setProduct(1,even.target.value,0);
        setLoder("d-none");
    };
    ...
    const getSubmitValue = async () => {
        setLoder("");
        await setProduct(1,perPage,searchValue);
        setLoder("d-none")
    };
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-4">
                                            <div className="input-group mb-3">
                                                ...
                                                <button onClick={getSubmitValue}  className="btn  btn-success btn-sm mb-0" type="button">Search</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                            ...
                                            <div className="table-responsive table-section">
                                                <table className="table ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Category Name</td>
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Brand Name</td>
                                                        <td className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Product     Name</td>
                                                        ...
                                                        productList.map((item,i)=>{
                                                            return (
                                                                <tr key={i}>
                                                                    ...
                                                                    <td><p
                                                                        className="text-xs text-start mt-2 "> {item["category"]["0"] ? item["category"]["0"]["name"] : "" }
                                                                    </p></td>
                                                                    <td><p
                                                                        className="text-xs text-start mt-2 "> {item["brand"]["0"] ? item["brand"]["0"]["name"] : "" }
                                                                    </p></td>
                                                                    <td><p
                                                                        className="text-xs text-start mt-2 "> {item["name"]}
                                                                    </p></td>
                                                                    <td><p
                                                                        className="text-xs text-start mt-2 "> {item["unit"]}
                                                                    </p></td>
                                                                    <td><p
                                                                        className="text-xs text-start mt-2 "> {item["details"]}
                                                                    </p></td>
                                                                    <td><p
                                                                    ...
                                                                    <td>
                                                                        <Link to= {`/product/update/${item["_id"]}`} title={"Update"}
