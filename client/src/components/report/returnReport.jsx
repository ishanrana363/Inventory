...
const ReturnReport = () => {
    const {returnReportData,setReturnReportData} = reportStore()
    ...
    const submitInputValue = async () => {
        if (isEmpty(fromDate)){
            ...
            setLoder("");
            await setReturnReportData(fromDate,toDate);
            setLoder("d-none");
        }
    };
    return (
                    ...
                    <div className="col-12">
                        <div className="card-body">
                            <div className="row d-flex ">
                                <h5 className="text-center ">Return Report by Date</h5>
                            ...
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col">
                                                <h6 className="animated fadeInLeft ms-3 " >Total: {returnReportData[0]['Total'].length>0?<CurrencyFormat value={returnReportData[0]['Total'][0]['totalAmount']} displayType={'text'} thousandSeparator={true} prefix={'$ '} />:0} </h6>
                                                <button  onClick={onExport.bind(this,'csv',returnReportData[0]['Rows'])}  className="btn btn-sm my-2 btn-success animated fadeInRight ms-3 ">Download CSV</button>
                                                <button onClick={onExport.bind(this,'xls',returnReportData[0]['Rows'])}   className="btn btn-sm my-2 ms-2 btn-success animated fadeInLeft ms-3 ">Download XLS</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
